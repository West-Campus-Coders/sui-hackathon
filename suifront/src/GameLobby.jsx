...
export default class GameLobby extends Component {
  ...
  handleEndGame() {
    fetch(`https://deckofcardsapi.com/api/deck/new/shuffle/?deck_count=8`)
      ...
      .then((json) => {
        this.setState({
          //Game ends sets a new deckId to get a new deck from Api
          deckId: json.deck_id,
        });
      });
    this.setState({
  ...
  //Potentially have sui coins added here
  increaseChipOne = () => {
    this.setState({
